...
public class TSolutionsDAO {
	...
	public void save(TSolutions transientInstance) {
		log.debug("saving TSolutions instance");
		try {
	...
	public void delete(TSolutions persistentInstance) {
		log.debug("deleting TSolutions instance");
		try {
	...
	public TSolutions findById(java.lang.String id) {
		log.debug("getting TSolutions instance with id: " + id);
		try {
	...
	public List findByExample(TSolutions instance) {
		log.debug("finding TSolutions instance by example");
		try {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding TSolutions instance with property: " + propertyName
				+ ", value: " + value);
		try {
	...
	public List findAll() {
		log.debug("finding all TSolutions instances");
		try {
	...
	public TSolutions merge(TSolutions detachedInstance) {
		log.debug("merging TSolutions instance");
		try {
	...
	public void attachDirty(TSolutions instance) {
		log.debug("attaching dirty TSolutions instance");
		try {
	...
	public void attachClean(TSolutions instance) {
		log.debug("attaching clean TSolutions instance");
		try {
